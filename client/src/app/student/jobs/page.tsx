        ...
        <div className="lg:hidden fixed inset-x-0 bottom-0 top-20 z-[999] bg-white dark:bg-zinc-950 flex flex-col animate-in slide-in-from-bottom duration-300 shadow-2xl">
          ...
          <div className="flex items-center justify-between px-3 py-2.5 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shrink-0 shadow-sm">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              >
                <CheckCircle2 className={`w-4 h-4 ${appliedJobs[selectedJob.id] ? "fill-emerald-500 text-white" : ""}`} />
              </button>
            </div>
          </div>
            ...
            <div className="p-4 space-y-6">
              ...
              {selectedJob.aiRationale && (
                <div className="p-3.5 bg-indigo-500/5 border border-indigo-500/20 rounded-2xl flex gap-3 text-xs text-indigo-700 dark:text-indigo-300">
                  <BrainCircuit className="w-5 h-5 shrink-0 text-indigo-500 animate-pulse mt-0.5" />
                  <div>
              ...
              {selectedJob.responsibilities && selectedJob.responsibilities.length > 0 && (
                <div className="space-y-3">
                  <h3 className="text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5">
                    <Briefcase className="w-3.5 h-3.5 text-indigo-500" /> Key Responsibilities
                  </h3>
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 mb-2.5">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      >
                        <CheckCircle2 className={`w-3.5 h-3.5 ${appliedJobs[job.id] ? "fill-emerald-500 text-white" : ""}`} />
                      </button>
                    </div>
                  </div>
