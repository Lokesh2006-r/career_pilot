      ...
      <div className="flex h-screen overflow-hidden bg-background text-foreground font-sans">
        ...
        <div className="flex-1 flex flex-col overflow-hidden relative">
          ...
          <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-white/85 dark:bg-zinc-950/85 backdrop-blur-lg border-t border-zinc-200/50 dark:border-zinc-800/40 flex items-center justify-around px-2 z-30 shadow-[0_-4px_12px_rgba(0,0,0,0.03)]">
            <BottomTabItem href="/recruiter/dashboard" icon={<Home className="w-5 h-5" />} label="Overview" active={pathname === "/recruiter/dashboard"} />
            <BottomTabItem href="/recruiter/search" icon={<Search className="w-5 h-5" />} label="Search" active={pathname === "/recruiter/search"} />
            <BottomTabItem href="/recruiter/shortlist" icon={<UserCheck className="w-5 h-5" />} label="Shortlist" active={pathname === "/recruiter/shortlist"} />
            <BottomTabItem href="/recruiter/analytics" icon={<TrendingUp className="w-5 h-5" />} label="Analytics" active={pathname === "/recruiter/analytics"} />
          </nav>
        </div>
      </div>
    </RoleGuard>
